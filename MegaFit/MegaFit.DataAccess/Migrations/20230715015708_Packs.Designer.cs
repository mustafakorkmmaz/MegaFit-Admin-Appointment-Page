...
namespace MegaFit.DataAccess.Migrations
{
    ...
    [Migration("20230715015708_Packs")]
    partial class Packs
    {
            ...
            modelBuilder.Entity("MegaFit.EntityLayer.Entities.CustomerVisit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsSick = true,
                            UsingDrugs = true,
                            VisitDate = new DateTime(2023, 7, 15, 4, 57, 7, 793, DateTimeKind.Local).AddTicks(8577)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            IsSick = false,
                            UsingDrugs = false,
                            VisitDate = new DateTime(2023, 7, 15, 4, 57, 7, 795, DateTimeKind.Local).AddTicks(2575)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            IsSick = true,
                            UsingDrugs = false,
                            VisitDate = new DateTime(2023, 7, 15, 4, 57, 7, 795, DateTimeKind.Local).AddTicks(2582)
                        });
                });
