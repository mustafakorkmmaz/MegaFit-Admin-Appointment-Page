...
namespace MegaFit.DataAccess.Migrations
{
    ...
    [Migration("20230714161419_SicknessListUpgrade")]
    partial class SicknessListUpgrade
    {
            ...
            modelBuilder.Entity("MegaFit.EntityLayer.Entities.CustomerVisit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsSick = true,
                            UsingDrugs = true,
                            VisitDate = new DateTime(2023, 7, 14, 19, 14, 19, 227, DateTimeKind.Local).AddTicks(982)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            IsSick = false,
                            UsingDrugs = false,
                            VisitDate = new DateTime(2023, 7, 14, 19, 14, 19, 228, DateTimeKind.Local).AddTicks(5068)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            IsSick = true,
                            UsingDrugs = false,
                            VisitDate = new DateTime(2023, 7, 14, 19, 14, 19, 228, DateTimeKind.Local).AddTicks(5075)
                        });
                });
