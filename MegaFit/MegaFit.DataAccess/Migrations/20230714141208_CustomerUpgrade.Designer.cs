...
namespace MegaFit.DataAccess.Migrations
{
    ...
    [Migration("20230714141208_CustomerUpgrade")]
    partial class CustomerUpgrade
    {
            ...
            modelBuilder.Entity("MegaFit.EntityLayer.Entities.CustomerVisit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsSick = true,
                            UsingDrugs = true,
                            VisitDate = new DateTime(2023, 7, 14, 17, 12, 8, 75, DateTimeKind.Local).AddTicks(9157)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            IsSick = false,
                            UsingDrugs = false,
                            VisitDate = new DateTime(2023, 7, 14, 17, 12, 8, 77, DateTimeKind.Local).AddTicks(3376)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            IsSick = true,
                            UsingDrugs = false,
                            VisitDate = new DateTime(2023, 7, 14, 17, 12, 8, 77, DateTimeKind.Local).AddTicks(3408)
                        });
                });
